...
class TransformerConfig(FairseqDataclass):
    ...
    re_tuned: bool = field(
        default=False, metadata={"help": "finetuning an existing fine-tuned model"}
    )
    adapter: bool = field(
        default=False, metadata={"help": "using adapter during fine-tuning"}
    )
    adapter_enc_dim: float = field(
        default=0.0, metadata={"help": "Adapter dimension in encoder."}
    )
    adapter_dec_dim: float = field(
        default=0.0, metadata={"help": "Adapter dimension in decoder."}
    )
    adapter_groups: str = field(
        default="", metadata={"help": "create adapters of these groups"}
    )
    adapter_families: str = field(
        default="", metadata={"help": "create adapters of these families"}
    )
    adapter_langs: str = field(
        default="", metadata={"help": "create adapters of these languages"}
    )
    adapter_hierarchies: str = field(
        default="", metadata={"help": "how the adapters of the encoder will be stacked"}
    )
    adapter_unfreeze: str = field(
        default="", metadata={"help": "which adapters need updating"}
    )
